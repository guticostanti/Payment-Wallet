            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><i class="fa fa-cash"></i><strong>Carteira Digital</strong></a>
                    </div>
                    <!-- end:navbar-header -->
...
</html>	<?php /**PATH D:\Meus repositórios github\Payment-Wallet\resources\views/layouts/app.blade.php ENDPATH**/ ?>